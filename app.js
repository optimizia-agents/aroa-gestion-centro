...
function syncProviderField(){const field=$('edit-provider-field'),type=$('edit-type'),input=$('edit-provider');if(!field||!type)return;const external=type.value==='EXTERNO';field.hidden=!external;if(input){input.disabled=!external;if(!external)input.value=''}}
