...
async function saveImprovementEditor(){const name=sentenceCaseIfAllCaps($('improvement-edit-name').value.trim());if(!name){editorMessage($('improvement-editor'),'Escribe el concepto de la compra o mejora.');return}const changes={name,category:sentenceCaseIfAllCaps($('improvement-edit-category').value.trim()),status:$('improvement-edit-status').value,date:$('improvement-edit-date').value?dateFromEditor($('improvement-edit-date').value):'',detectionDate:$('improvement-edit-date').value?dateFromEditor($('improvement-edit-date').value):'',requestDate:$('improvement-edit-request-date').value?dateFromEditor($('improvement-edit-request-date').value):'',orderDate:$('improvement-edit-order-date').value?dateFromEditor($('improvement-edit-order-date').value):'',completionDate:$('improvement-edit-completion-date').value?dateFromEditor($('improvement-edit-completion-date').value):'',justification:$('improvement-edit-justification').value.trim(),action:$('improvement-edit-action').value.trim(),result:$('improvement-edit-result').value.trim(),provider:$('improvement-edit-provider').value.trim(),supplierNumber:$('improvement-edit-supplier').value.trim(),requestNumber:$('improvement-edit-request').value.trim(),orderNumber:$('improvement-edit-order').value.trim(),amount:formatMoneyValue($('improvement-edit-amount').value)||'',expenseType:$('improvement-edit-expense').value,contactId:$('improvement-edit-contact').value||'',contactName:$('improvement-edit-contact-name').value.trim(),contactEmail:$('improvement-edit-contact-email').value.trim(),budgetUrl:$('improvement-edit-budget').value.trim(),deliveryNoteUrl:$('improvement-edit-delivery').value.trim(),invoiceUrl:$('improvement-edit-invoice').value.trim(),reportUrl:$('improvement-edit-report').value.trim(),visible:$('improvement-edit-visible').checked,beforeUrls:readImprovementPhotoValues('before'),afterUrls:readImprovementPhotoValues('after'),beforeUrl:readImprovementPhotoValues('before')[0]||'',afterUrl:readImprovementPhotoValues('after')[0]||'',observations:$('improvement-edit-observations').value.trim()};return commitEditor('improvements',improvementEditorIndex,changes,'improvement-editor',closeImprovementEditor)}
...
function applyConfirmedDocument(doc){
 ...
 refreshKurroPeopleOptions();refreshClientOptions();refreshKURROMetrics();renderCenter();renderPending();renderClients();renderTemplates();renderProcedures();renderProviders();renderImprovements();renderEconomicAnalysis();
