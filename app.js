...
function renderEconomicAnalysis(){
 ...
 renderAnalysisBars('analysis-category-chart',aggregate('category'),total,'No hay importes para este filtro.');
 ...
 renderAnalysisBars('analysis-year-chart',[...yearTotals.entries()].sort((a,b)=>String(a[0]).localeCompare(String(b[0]))),total,'No hay años para este filtro.');
